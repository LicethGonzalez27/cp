...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2016 a las 10:07:55
...
(3, 103, 'CMI765', 'Chevrolet', 'Camioneta', '2005'),
...
(1, 1019037667, '2016-10-04', '2016-12-06', 1, 1);
...
(2, 1234, 'Liz', 'Gonzalez', '', '', ''),
(3, 12345, 'Leidy', 'Torres', '', '', ''),
(4, 123456, 'Emmanuel', 'Neiza', '', '', ''),
(5, 1234567, 'Sara', 'Correa', '', '', ''),
(6, 123, 'Sebastian', 'Tabora', '', '', ''),
(7, 12, 'Camilo', 'Villegas', '', '', ''),
(8, 987, 'Juliana', 'Parra', '', '', ''),
(9, 7654, 'Taliana', 'Muñoz', '', '', ''),
(10, 20927312, 'Lina', 'Toledo', 'Crra.7 #23-2', '3123233122', '');
...
(4, '00004', '2016-01-07', '2016-12-04', 2, 2);
...
(2, 'TO1235', 4, '2016-06-16', '2016-11-15', 2, 1),
